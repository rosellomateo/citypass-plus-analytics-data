"""Reconstruye silver/Emergencias y Seguridad/emergencias.parquet desde
cero, reprocesando TODOS los eventos que ya existen en bronze/Emergencias y
Seguridad/.
...
Uso:
    python scripts/reprocesar_emergencias_silver.py
"""
import json
import os
import sys
...
from emergencias.bp_emergencias_silver import (  # noqa: E402
    aplicar_evento,
    dataframe_vacio,
    escribir_tabla,
    get_blob_client,
...
def main():
    ...
    for blob in container_client.list_blobs(name_starts_with=PREFIJO_EMERGENCIAS):
