"""Reconstruye silver/Movilidad Urbana/viajes.parquet desde cero, reprocesando
TODOS los eventos que ya existen en bronze/Movilidad Urbana/.
...
Uso:
    python scripts/reprocesar_movilidad_silver.py
"""
import json
import os
import sys
...
def main():
    ...
    for blob in container_client.list_blobs(name_starts_with=PREFIJO_MOVILIDAD):
